...
const questions = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["var x = 10;", "variable x = 10;", "int x = 10;", "var 10 = x;"],
        correctAnswer: 0,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Kublai Khan", "Sun Yat-sen", "Qin Shi Huang", "Wu Zetian"],
        correctAnswer: 2,
      },
      {
      ...
      },
      {
        ...
        options: ["Amelia Earhart", "Bessie Coleman", "Harriet Quimby", "Anne Morrow Lindbergh"],
        correctAnswer: 0,
      },
      {
      ...
      },
      {
        ...
        options: ["Victoria", "Elizabeth II", "George III", "Henry VIII"],
        correctAnswer: 1,
      },
      {
        question: "When was the first Olympic Games held in ancient Greece?",
        options: ["776 BC", "676 BC", "576 BC", "476 BC"],
        correctAnswer: 0,
      },
      {
